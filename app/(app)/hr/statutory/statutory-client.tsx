...
export function StatutoryClient({ rows, employees, canCreate, canEdit, canDelete, canExport = false }: Props) {
  ...
  return (
    <div className="space-y-4">
      <DataIoToolbar entityKey="hr_statutory_docs" rows={rows} canExport={canExport} />
      {canCreate &&
        (open ? (
          <Card>
            <CardHeader>
