...
export default async function WorkersPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      />
      {/*
        THE SAME COMPONENT STAFF USES. A worker's record IS the staff record
        (client 2026-09-09) — same rail, same six tabs, same child grids — so
        this passes `kind="worker"` rather than rendering a second copy that
