...
import { listMaterialBoms } from "@/lib/planning/bom-service";
...
import type { MaterialBomRow } from "@/lib/planning/bom-service";
...
const columns: Column<MaterialBomRow>[] = [
  {
    header: "Code",
    cell: (r) => (
      <Link
        href={`/planning/material-bom/${r.id}`}
    ...
    <div className="space-y-4">
      <PageHeader
        ...
        actions={
          canCreate ? (
            <Link
              href="/planning/material-bom/new"
