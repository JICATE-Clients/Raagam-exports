...
import { getProcessingPpm } from "@/lib/planning/ppm-service";
import { fmtDate } from "@/lib/format";
import { PageHeader } from "@/components/ui/page-header";
import { StatusPill } from "@/components/ui/status-pill";
import type { StatusTone } from "@/components/ui/status-pill";
import type { PpmStatus } from "@/lib/planning/ppm-types";
import { ProcessingPpmDetail } from "./processing-ppm-detail";
...
export default async function ProcessingPpmDetailPage({
  params,
}: {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title={ppm.code ?? "Processing PPM"}
        description={`Customer: ${ppm.customer_name ?? "\u2014"} \u00b7 Group: ${ppm.group_no ?? "\u2014"} \u00b7 ${fmtDate(ppm.ppm_date)}`}
        actions={
