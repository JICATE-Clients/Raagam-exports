      ...
      >
        ...
        <SectionGrid>
          <DetailSection label="Details" cols={12}>
            ...
            <Field label="Entry No" size="sm" htmlFor="pt-entry">
              <Input id="pt-entry" value={editEntryNo ?? "(auto)"} disabled />
            </Field>
            <Field label="Date" size="sm" htmlFor="pt-date">
              <Input
                id="pt-date"
                type="date"
            ...
            <Field label="Pay Mode" size="md" htmlFor="pt-paymode">
              <Select
                id="pt-paymode"
                value={form.pay_mode}
            ...
            <Field label="Credit Days" size="xs" htmlFor="pt-credit">
              <Input
                id="pt-credit"
                type="number"
                min="0"
            ...
            <Field label="Description" size="full" htmlFor="pt-desc">
              <Textarea
                id="pt-desc"
                rows={3}
