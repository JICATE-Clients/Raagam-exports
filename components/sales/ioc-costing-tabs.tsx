...
function StyleCostsSummaryTab({ styleCosts, costSheetId, opportunityId, currency, canEdit }: {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable paginate={false} columns={columns} rows={styleCosts} getKey={(r) => r.id} empty="No style costs added yet." />
    </div>
  );
}
...
function FabricRatesTab({ fabricRates, costSheetId, opportunityId, currency, canEdit }: {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable paginate={false} columns={columns} rows={fabricRates} getKey={(r) => r.id} />
    </div>
  );
}
...
function OtherExpensesTab({ expenses, costSheetId, opportunityId, currency, canEdit }: {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable paginate={false} columns={columns} rows={expenses} getKey={(r) => r.id} />
...
function BudgetSummaryTab({ budgets, currency }: { budgets: IocBudget[]; currency?: string | null }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTable paginate={false} columns={columns} rows={budgets} getKey={(r) => r.id} />
    </div>
  );
}
