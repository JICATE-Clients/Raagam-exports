...
export const SUBMODULES: SubmoduleDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { slug: "ta-approvals", label: "TA Approvals", singular: "Approval", description: "Global technical approval milestones (Fit Sample, PP Sample, …) used by Orders' T&A engine", type: "custom", custom: "ta_approval" },
    ],
  },
];
